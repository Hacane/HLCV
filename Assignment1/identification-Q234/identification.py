...
plt.bar((bin_gray2[0:-1] + bin_gray2[1:])/2, hist_gray2,width=0.01)  ##width is added to make the view of graph look decent
plt.show()
...
plt.subplot(1,4,4)
hist_dydx = histogram_module.dxdy_hist(img_gray, num_bins_color)
plt.bar(np.array(range(1,hist_dydx.size+1)),hist_dydx)
plt.show()
